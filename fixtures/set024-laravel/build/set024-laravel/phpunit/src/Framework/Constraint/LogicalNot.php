 ...
 * Logical NOT.
 */
class LogicalNot extends \_PhpScoper5b2c11ee6df50\PHPUnit\Framework\Constraint\Constraint
{
    /**
     * @var Constraint
     */
    ...
    public function __construct($constraint)
    {
        ...
        if (!$constraint instanceof \_PhpScoper5b2c11ee6df50\PHPUnit\Framework\Constraint\Constraint) {
            $constraint = new \_PhpScoper5b2c11ee6df50\PHPUnit\Framework\Constraint\IsEqual($constraint);
        }
    ...
    public function toString() : string
    {
        switch (\get_class($this->constraint)) {
            case \_PhpScoper5b2c11ee6df50\PHPUnit\Framework\Constraint\LogicalAnd::class:
            case self::class:
            case \_PhpScoper5b2c11ee6df50\PHPUnit\Framework\Constraint\LogicalOr::class:
