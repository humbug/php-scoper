 ...
 */
abstract class Constraint implements \Countable, \_PhpScoper5b2c11ee6df50\PHPUnit\Framework\SelfDescribing
{
    protected $exporter;
    public function __construct()
    {
        $this->exporter = new \_PhpScoper5b2c11ee6df50\SebastianBergmann\Exporter\Exporter();
    }
    /**
    ...
    protected function fail($other, $description, \_PhpScoper5b2c11ee6df50\SebastianBergmann\Comparator\ComparisonFailure $comparisonFailure = null) : void
    {
        ...
        throw new \_PhpScoper5b2c11ee6df50\PHPUnit\Framework\ExpectationFailedException($failureDescription, $comparisonFailure);
    }
    /**
