...
use Throwable;
class Exception extends \_PhpScoper5b2c11ee6df50\PHPUnit\Framework\Constraint\Constraint
{
    /**
     * @var string
     */
    ...
    protected function failureDescription($other) : string
    {
        if ($other !== null) {
            ...
            if ($other instanceof \Throwable) {
                $message = '. Message was: "' . $other->getMessage() . '" at' . "\n" . \_PhpScoper5b2c11ee6df50\PHPUnit\Util\Filter::getFilteredStacktrace($other);
            }
