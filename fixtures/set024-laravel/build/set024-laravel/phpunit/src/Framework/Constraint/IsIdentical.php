 ...
 */
class IsIdentical extends \_PhpScoper5b2c11ee6df50\PHPUnit\Framework\Constraint\Constraint
{
    /**
     * @var float
     */
    ...
    public function evaluate($other, $description = '', $returnResult = \false)
    {
        ...
        if (!$success) {
            ...
            if (\is_string($this->value) && \is_string($other)) {
                $f = new \_PhpScoper5b2c11ee6df50\SebastianBergmann\Comparator\ComparisonFailure($this->value, $other, \sprintf("'%s'", $this->value), \sprintf("'%s'", $other));
            }
            // if both values are array, make sure a diff is generated
            if (\is_array($this->value) && \is_array($other)) {
                $f = new \_PhpScoper5b2c11ee6df50\SebastianBergmann\Comparator\ComparisonFailure($this->value, $other, $this->exporter->export($this->value), $this->exporter->export($other));
            }
