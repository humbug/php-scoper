 ...
 */
class IsEqual extends \_PhpScoper5b2c11ee6df50\PHPUnit\Framework\Constraint\Constraint
{
    /**
     * @var mixed
     */
    ...
    public function evaluate($other, $description = '', $returnResult = \false)
    {
        ...
        $comparatorFactory = \_PhpScoper5b2c11ee6df50\SebastianBergmann\Comparator\Factory::getInstance();
        try {
        ...
        } catch (\_PhpScoper5b2c11ee6df50\SebastianBergmann\Comparator\ComparisonFailure $f) {
            if ($returnResult) {
                return \false;
            }
            throw new \_PhpScoper5b2c11ee6df50\PHPUnit\Framework\ExpectationFailedException(\trim($description . "\n" . $f->getMessage()), $f);
        }
        return \true;
    }
    /**
