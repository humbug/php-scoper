 ...
 */
class StaticInvocation implements \_PhpScoper5b2c11ee6df50\PHPUnit\Framework\MockObject\Invocation, \_PhpScoper5b2c11ee6df50\PHPUnit\Framework\SelfDescribing
{
    /**
     * @var array
     */
    private static $uncloneableExtensions = ['mysqli' => \true, 'SQLite' => \true, 'sqlite3' => \true, 'tidy' => \true, 'xmlwriter' => \true, 'xsl' => \true];
    /**
     * @var array
     */
    ...
    public function generateReturnValue()
    {
        ...
        switch (\strtolower($this->returnType)) {
            ...
            case 'iterable':
                ...
                return $generator();
            default:
                $generator = new \_PhpScoper5b2c11ee6df50\PHPUnit\Framework\MockObject\Generator();
