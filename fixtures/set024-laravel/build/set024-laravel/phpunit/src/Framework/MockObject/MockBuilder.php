...
class MockBuilder
{
     ...
     */
    public function __construct(\_PhpScoper5b2c11ee6df50\PHPUnit\Framework\TestCase $testCase, $type)
    {
        $this->testCase = $testCase;
        $this->type = $type;
        $this->generator = new \_PhpScoper5b2c11ee6df50\PHPUnit\Framework\MockObject\Generator();
    }
    /**
    ...
    {
        $object = $this->generator->getMock($this->type, $this->methods, $this->constructorArgs, $this->mockClassName, $this->originalConstructor, $this->originalClone, $this->autoload, $this->cloneArguments, $this->callOriginalMethods, $this->proxyTarget, $this->allowMockingUnknownTypes, $this->returnValueGeneration);
