 ...
 * exception.
 */
class InvokedCount extends \_PhpScoper5b2c11ee6df50\PHPUnit\Framework\MockObject\Matcher\InvokedRecorder
{
    /**
     * @var int
     */
    ...
    public function invoked(\_PhpScoper5b2c11ee6df50\PHPUnit\Framework\MockObject\Invocation $invocation) : void
    {
        ...
        if ($count > $this->expectedCount) {
            ...
            throw new \_PhpScoper5b2c11ee6df50\PHPUnit\Framework\ExpectationFailedException($message);
        }
    }
    /**
    ...
    public function verify() : void
    {
        $count = $this->getInvocationCount();
        if ($count !== $this->expectedCount) {
            throw new \_PhpScoper5b2c11ee6df50\PHPUnit\Framework\ExpectationFailedException(\sprintf('Method was expected to be called %d times, ' . 'actually called %d times.', $this->expectedCount, $count));
        }
    }
}
