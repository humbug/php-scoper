...
class BuilderTest extends \_PhpScoper5b2c11ee6df50\SebastianBergmann\CodeCoverage\TestCase
{
    protected $factory;
    protected function setUp()
    {
        $this->factory = new \_PhpScoper5b2c11ee6df50\SebastianBergmann\CodeCoverage\Node\Builder();
    }
    ...
    {
        $method = new \ReflectionMethod(\_PhpScoper5b2c11ee6df50\SebastianBergmann\CodeCoverage\Node\Builder::class, 'buildDirectoryStructure');
    ...
    {
        $method = new \ReflectionMethod(\_PhpScoper5b2c11ee6df50\SebastianBergmann\CodeCoverage\Node\Builder::class, 'reducePaths');
        $method->setAccessible(\true);
