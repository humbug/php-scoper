 ...
 */
final class File extends \_PhpScoper5b2c11ee6df50\SebastianBergmann\CodeCoverage\Node\AbstractNode
{
    /**
     * @var array
     */
    ...
    public function __construct(string $name, \_PhpScoper5b2c11ee6df50\SebastianBergmann\CodeCoverage\Node\AbstractNode $parent, array $coverageData, array $testData, bool $cacheTokens)
    {
    ...
    {
        if ($this->cacheTokens) {
            $tokens = \_PhpScoper5b2c11ee6df50\PHP_Token_Stream_CachingFactory::get($this->getPath());
        } else {
            $tokens = new \_PhpScoper5b2c11ee6df50\PHP_Token_Stream($this->getPath());
        }
    ...
    private function processClasses(\_PhpScoper5b2c11ee6df50\PHP_Token_Stream $tokens) : void
    {
    ...
    private function processTraits(\_PhpScoper5b2c11ee6df50\PHP_Token_Stream $tokens) : void
    {
    ...
    private function processFunctions(\_PhpScoper5b2c11ee6df50\PHP_Token_Stream $tokens) : void
    {
    ...
    private function crap(int $ccn, float $coverage) : string
    {
        ...
        return \sprintf('%01.2F', $ccn ** 2 * (1 - $coverage / 100) ** 3 + $ccn);
    }
