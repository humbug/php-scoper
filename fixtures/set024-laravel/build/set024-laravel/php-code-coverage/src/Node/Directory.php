...
use _PhpScoper5b2c11ee6df50\SebastianBergmann\CodeCoverage\InvalidArgumentException;
/**
 * Represents a directory in the code coverage information tree.
 */
final class Directory extends \_PhpScoper5b2c11ee6df50\SebastianBergmann\CodeCoverage\Node\AbstractNode implements \IteratorAggregate
{
    /**
     * @var AbstractNode[]
     */
    ...
    {
        return new \RecursiveIteratorIterator(new \_PhpScoper5b2c11ee6df50\SebastianBergmann\CodeCoverage\Node\Iterator($this), \RecursiveIteratorIterator::SELF_FIRST);
    }
    /**
     ...
     */
    public function addFile(string $name, array $coverageData, array $testData, bool $cacheTokens) : \_PhpScoper5b2c11ee6df50\SebastianBergmann\CodeCoverage\Node\File
    {
        $file = new \_PhpScoper5b2c11ee6df50\SebastianBergmann\CodeCoverage\Node\File($name, $this, $coverageData, $testData, $cacheTokens);
        $this->children[] = $file;
