...
final class Builder
{
    public function build(\_PhpScoper5b2c11ee6df50\SebastianBergmann\CodeCoverage\CodeCoverage $coverage) : \_PhpScoper5b2c11ee6df50\SebastianBergmann\CodeCoverage\Node\Directory
    {
        $files = $coverage->getData();
        $commonPath = $this->reducePaths($files);
        $root = new \_PhpScoper5b2c11ee6df50\SebastianBergmann\CodeCoverage\Node\Directory($commonPath, null);
        $this->addItems($root, $this->buildDirectoryStructure($files), $coverage->getTests(), $coverage->getCacheTokens());
        return $root;
    }
    private function addItems(\_PhpScoper5b2c11ee6df50\SebastianBergmann\CodeCoverage\Node\Directory $root, array $items, array $tests, bool $cacheTokens) : void
    {
