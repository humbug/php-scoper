 ...
 * @codeCoverageIgnore
 */
final class Xdebug implements \_PhpScoper5b2c11ee6df50\SebastianBergmann\CodeCoverage\Driver\Driver
{
    /**
     * @var array
     */
    ...
    public function __construct()
    {
        if (!\extension_loaded('xdebug')) {
            throw new \_PhpScoper5b2c11ee6df50\SebastianBergmann\CodeCoverage\RuntimeException('This driver requires Xdebug');
        }
        if (!\ini_get('xdebug.coverage_enable')) {
            throw new \_PhpScoper5b2c11ee6df50\SebastianBergmann\CodeCoverage\RuntimeException('xdebug.coverage_enable=On has to be set in php.ini');
        }
    }
    /**
