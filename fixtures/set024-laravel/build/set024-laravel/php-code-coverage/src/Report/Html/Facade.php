...
final class Facade
{
    ...
    public function process(\_PhpScoper5b2c11ee6df50\SebastianBergmann\CodeCoverage\CodeCoverage $coverage, string $target) : void
    {
        ...
        $dashboard = new \_PhpScoper5b2c11ee6df50\SebastianBergmann\CodeCoverage\Report\Html\Dashboard($this->templatePath, $this->generator, $date, $this->lowUpperBound, $this->highLowerBound);
        $directory = new \_PhpScoper5b2c11ee6df50\SebastianBergmann\CodeCoverage\Report\Html\Directory($this->templatePath, $this->generator, $date, $this->lowUpperBound, $this->highLowerBound);
        $file = new \_PhpScoper5b2c11ee6df50\SebastianBergmann\CodeCoverage\Report\Html\File($this->templatePath, $this->generator, $date, $this->lowUpperBound, $this->highLowerBound);
    ...
    private function getDirectory(string $directory) : string
    {
        ...
        if (!$this->createDirectory($directory)) {
            throw new \_PhpScoper5b2c11ee6df50\SebastianBergmann\CodeCoverage\RuntimeException(\sprintf('Directory "%s" does not exist.', $directory));
        }
        return $directory;
    }
