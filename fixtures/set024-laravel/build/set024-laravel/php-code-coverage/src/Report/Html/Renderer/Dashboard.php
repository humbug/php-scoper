 ...
 */
final class Dashboard extends \_PhpScoper5b2c11ee6df50\SebastianBergmann\CodeCoverage\Report\Html\Renderer
{
    /**
     * @throws \InvalidArgumentException
     * @throws \RuntimeException
     */
    public function render(\_PhpScoper5b2c11ee6df50\SebastianBergmann\CodeCoverage\Node\Directory $node, string $file)
    {
        $classes = $node->getClassesAndTraits();
        $template = new \_PhpScoper5b2c11ee6df50\Text_Template($this->templatePath . 'dashboard.html', '{{', '}}');
