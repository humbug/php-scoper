...
class PHP_Token_ClosureTest extends \_PhpScoper5b2c11ee6df50\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $ts = new \_PhpScoper5b2c11ee6df50\PHP_Token_Stream(\TEST_FILES_PATH . 'closure.php');
        foreach ($ts as $token) {
