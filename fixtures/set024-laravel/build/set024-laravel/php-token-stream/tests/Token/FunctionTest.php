...
class PHP_Token_FunctionTest extends \_PhpScoper5b2c11ee6df50\PHPUnit\Framework\TestCase
{
    /**
    ...
    {
        $ts = new \_PhpScoper5b2c11ee6df50\PHP_Token_Stream(\TEST_FILES_PATH . 'source.php');
        foreach ($ts as $token) {
    ...
    {
        $ts = new \_PhpScoper5b2c11ee6df50\PHP_Token_Stream(\TEST_FILES_PATH . 'source5.php');
        $f = $ts->getFunctions();
        $c = $ts->getClasses();
        $i = $ts->getInterfaces();
