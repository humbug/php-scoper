...
class PHP_Token_ClassTest extends \_PhpScoper5b2c11ee6df50\PHPUnit\Framework\TestCase
{
    /**
     * @var PHP_Token_CLASS
     */
    ...
    {
        $ts = new \_PhpScoper5b2c11ee6df50\PHP_Token_Stream(\TEST_FILES_PATH . 'source2.php');
        foreach ($ts as $token) {
            if ($token instanceof \_PhpScoper5b2c11ee6df50\PHP_Token_CLASS) {
                $this->class = $token;
            }
            if ($token instanceof \_PhpScoper5b2c11ee6df50\PHP_Token_FUNCTION) {
                $this->function = $token;
                break;
            }
        }
    ...
    {
        $ts = new \_PhpScoper5b2c11ee6df50\PHP_Token_Stream(\TEST_FILES_PATH . 'issue19.php');
        foreach ($ts as $token) {
            if ($token instanceof \_PhpScoper5b2c11ee6df50\PHP_Token_CLASS) {
    ...
    {
        $ts = new \_PhpScoper5b2c11ee6df50\PHP_Token_Stream(\TEST_FILES_PATH . 'issue30.php');
        $this->assertCount(1, $ts->getClasses());
    }
    public function testAnonymousClassesAreHandledCorrectly()
    {
        $ts = new \_PhpScoper5b2c11ee6df50\PHP_Token_Stream(\TEST_FILES_PATH . 'class_with_method_that_declares_anonymous_class.php');
        $classes = $ts->getClasses();
        $this->assertEquals(['class_with_method_that_declares_anonymous_class', 'AnonymousClass:9#31', 'AnonymousClass:10#55', 'AnonymousClass:11#75', 'AnonymousClass:12#91', 'AnonymousClass:13#107'], \array_keys($classes));
    }
    /**
    ...
    {
        $ts = new \_PhpScoper5b2c11ee6df50\PHP_Token_Stream(\TEST_FILES_PATH . 'class_with_method_that_declares_anonymous_class2.php');
        $classes = $ts->getClasses();
    ...
    {
        $ts = new \_PhpScoper5b2c11ee6df50\PHP_Token_Stream(\TEST_FILES_PATH . 'classUsesNamespacedFunction.php');
        $this->assertEmpty($ts->getFunctions());
        $this->assertCount(1, $ts->getClasses());
    }
    /**
    ...
    {
        $ts = new \_PhpScoper5b2c11ee6df50\PHP_Token_Stream(\TEST_FILES_PATH . 'class_with_multiple_anonymous_classes_and_functions.php');
        $classes = $ts->getClasses();
    ...
    {
        $ts = new \_PhpScoper5b2c11ee6df50\PHP_Token_Stream(\TEST_FILES_PATH . 'class_with_method_named_empty.php');
        $classes = $ts->getClasses();
    ...
    {
        $ts = new \_PhpScoper5b2c11ee6df50\PHP_Token_Stream(\TEST_FILES_PATH . 'php-code-coverage-issue-424.php');
        $classes = $ts->getClasses();
