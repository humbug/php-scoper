...
return $this->services['Symfony\Bundle\FrameworkBundle\Controller\RedirectController'] = new RedirectController(($this->services['router'] ?? $this->getRouterService()), 80, 443);
