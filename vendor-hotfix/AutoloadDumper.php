...
final class AutoloadDumper
{
    ...
    public static function generateAutoloadStatements(
        ...
        $scoperStatements = self::getOriginalScoperAutoloaderContents($symbolsRegistry);
    ...
    private static function getOriginalScoperAutoloaderContents(SymbolsRegistry $symbolsRegistry): string
    {
