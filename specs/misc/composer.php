...
return [
    'meta' => new Meta(
        title: 'Some Composer files which caused problems at some point.',
    ),

    'ArrayLoader.php problematic sample' => <<<'PHP'
        <?php
    ...
    'ArrayLoader.php' => <<<'PHP'
        ...
        use Humbug\Composer\Package\CompleteAliasPackage;
        use Humbug\Composer\Package\CompletePackage;
        use Humbug\Composer\Package\RootPackage;
        use Humbug\Composer\Package\PackageInterface;
        use Humbug\Composer\Package\CompletePackageInterface;
        use Humbug\Composer\Package\Link;
        use Humbug\Composer\Package\RootAliasPackage;
        use Humbug\Composer\Package\Version\VersionParser;
        use Humbug\Composer\Pcre\Preg;
        /**
         * @author Konstantin Kudryashiv <ever.zet@gmail.com>
         * @author Jordi Boggiano <j.boggiano@seld.be>
         */
        class ArrayLoader implements LoaderInterface
        {
             ...
             * @inheritDoc
             */
            public function load(array $config, string $class = 'Humbug\Composer\Package\CompletePackage'): BasePackage
            {
                if ($class !== 'Humbug\Composer\Package\CompletePackage' && $class !== 'Humbug\Composer\Package\RootPackage') {
                    trigger_error('The $class arg is deprecated, please reach out to Composer maintainers ASAP if you still need this.', \E_USER_DEPRECATED);
                }
