    ...
    public static function specProvider(): iterable
    {
        ...
        yield 'simple spec' => [
            ...
            [
                ...
                'A spec with a title' => new SpecScenario(
                    null,
                    null,
                    'Fixtures/simple-spec-file.php',
        ...
        yield 'complete spec' => [
            ...
            [
                'Spec with default meta values' => new SpecScenario(
                    72_000,
                    83_000,
                ...
                'Spec with the more verbose form' => new SpecScenario(
                    72_000,
                    83_000,
                    'Fixtures/complete-spec-file.php',
                ...
                'Spec with overridden meta values' => new SpecScenario(
                    73_000,
                    82_000,
                    'Fixtures/complete-spec-file.php',
